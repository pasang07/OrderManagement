...
class CreateOrderListCancelbycustomers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_list_cancelbycustomers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('order_list_cancelbycustomers');
    }
}
