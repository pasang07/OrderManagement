                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            ...
                                            <div class="row invoive-info m-t-30">
                                                ...
                                                <div class="col-sm-4">
                                                    <h6 class="m-b-20">Total Purchased Items : {{$approveOrders->count()}}</h6>
                                                    @if($rejectedOrder > 0)
                                                        ...
                                                        <table class="table  invoice-detail-table">
                                                            ...
                                                            @foreach($allOrders as $k=>$orderItem)
                                                                ...
                                                                <tr id="{{$orderItem->id}}">
                                                                    ...
                                                                    <td>
                                                                        @if($orderItem->is_approve == "yes" && $orderItem->is_reject == "no" && $orderItem->is_confirm == "no")
                                                                            <h6 class="badge badge-info">Approved</h6>
                                                                        @elseif($orderItem->is_approve == "no" && $orderItem->is_reject == "yes" && $orderItem->is_cancelled == "no")
                                                                            <h6 class="badge badge-danger"> Rejected</h6>
                                                                        @elseif($orderItem->is_approve == "yes" && $orderItem->is_reject == "no" && $orderItem->is_confirm == "yes")
                                                                                <i class="fa fa-check-circle text-success"></i>
                                                                        @elseif($orderItem->is_reject == "yes" && $orderItem->is_cancelled == "yes")
                                            ...
                                            @if($allOrders->count() == $rejectedOrder)
                                                <div class="row">
                                                    <div class="col-sm-12 text-right">
                                                        <a href="{{route('all-order.reject', $orderList->order_no)}}" class="btn btn-success">Send Your Confirmation</a>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="row">
