                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:">Agents</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="button-card text-right">
                                            <a href="{{route('agent.create')}}"><button type="button" class="btn btn-dark"><i class="fas fa-plus"></i> Add Agent</button></a>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tr class="unread">
                                                        ...
                                                        <td>
                                                            <a href="{{route('agent.edit',$user->id)}}" ><button type="button" class="btn btn-icon btn-rounded btn-outline-primary"><i class="fas fa-edit"></i></button></a>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="{{route('agent.destroy',$user->id)}}" class="btn btn-danger">Delete</a>
                                                                ...
                                                                <div class="modal fade" id="resetPWModal-{{$k}}" tabindex="-1" role="dialog">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <a href="{{route('reset-agent-password',$user->id)}}" class="btn btn-info">Yes, Reset </a>
                                                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
