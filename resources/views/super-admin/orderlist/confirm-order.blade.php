                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <ul class="nav nav-tabs" id="OrderTab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active text-uppercase" id="fixedOrder-tab" data-toggle="tab" href="#fixedOrder" role="tab" aria-controls="fixedOrder" aria-selected="false">Confirmed Order</a>
                                                </li>
                                                <li class="nav-item">
                                            ...
                                            <div class="tab-content" id="OrderTabContent" style="-webkit-box-shadow: none;box-shadow: none;">
                                                ...
                                                <div class="tab-pane fade show active" id="fixedOrder" role="tabpanel" aria-labelledby="fixedOrder-tab">
                                                    <div class="table-responsive">
