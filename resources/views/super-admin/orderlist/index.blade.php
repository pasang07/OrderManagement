                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <ul class="nav nav-tabs" id="OrderTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active text-uppercase" id="allorder-tab" data-toggle="tab" href="#allorder" role="tab" aria-controls="allorder" aria-selected="true">All Orders</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link text-uppercase" id="cancelledOrder-tab" data-toggle="tab" href="#cancelledOrder" role="tab" aria-controls="cancelledOrder" aria-selected="false">Cancelled Order</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="OrderTabContent" style="-webkit-box-shadow: none;box-shadow: none;">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="col-reorder1" class="table table-hover todo-list ui-sortable">
                                                            ...
                                                            @foreach($allOrders as $k=>$orderList)
                                                                ...
                                                                $cancelled_items = \App\Models\Model\SuperAdmin\OrderList\OrderList::where('order_no', $orderList->order_no)->where('is_reject', 'yes')->get();
                                                                ...
                                                                <tr id="{{$orderList->id}}">
                                                                    ...
                                                                    <td>
                                                                        <h6>Purchased Order: {{$approved_orders}}</h6>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @else
                                                                            @if($orderList->reject_notification == 'not_sent')
                                                                            ...
                                                                            @else
                                                                                <a href="{{route('reject-order-details', $orderList->order_no)}}">
                                                                                    <button type="button" class="btn btn-icon btn-rounded btn-outline-primary">
                                                                                        <i class="fas fa-eye"></i>
                                                                                    </button>
                                                                                </a>
                                                ...
                                                <div class="tab-pane fade" id="cancelledOrder" role="tabpanel" aria-labelledby="cancelledOrder-tab">
                                                    <div class="col-sm-4 float-right">
