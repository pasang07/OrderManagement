...
<head>
    ...
    <!-- Smart Wizard css -->
    <link rel="stylesheet" href="{{asset('resources/super-admin/plugins/smart-wizard/css/smart_wizard.min.css')}}">
    <link rel="stylesheet" href="{{asset('resources/super-admin/plugins/smart-wizard/css/smart_wizard_theme_arrows.min.css')}}">
    <link rel="stylesheet" href="{{asset('resources/super-admin/plugins/smart-wizard/css/smart_wizard_theme_circles.min.css')}}">
    <link rel="stylesheet" href="{{asset('resources/super-admin/plugins/smart-wizard/css/smart_wizard_theme_dots.min.css')}}">
