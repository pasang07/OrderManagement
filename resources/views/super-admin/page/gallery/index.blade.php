                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="button-card text-right ">
                                            <a href="{{route('page-gallery.create',$page_id)}}"><button type="button" class="btn btn-dark"><i class="fas fa-plus"></i> Add Gallery</button></a>
                                            <div class="btn-group mb-2 mr-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" id="active" href="#!" data-id="pageGallery">Enable</a>
                                                    <a class="dropdown-item" id="deactive" href="#!" data-id="pageGallery">Disable</a>
                                                    <a class="dropdown-item" id="delete" href="#!" data-id="pageGallery">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-block">
                                            <div class="table-responsive">
                                                <table id="sortable" class="table table-hover todo-list ui-sortable">
                                                    ...
                                                    <tbody>
                                                    <?php $orders =''; $table='page_galleries'; ?>
                                                    ...
                                                    <tr id="{{$gallery->id}}">
                                                        ...
                                                        <td>
                                                            <div class="image-trap">
                                                                <a href="{{asset('uploads/PageGallery/thumbnail/'.$gallery->image)}}" data-toggle="lightbox" data-gallery="multiimages" data-title="" class=" img-responsive">
                                                                    <img class="" style="width:70px;" src="{{asset('uploads/PageGallery/thumbnail/'.$gallery->image)}}" alt="activity-user">
                                                                    <div class="g-title">
                                                        ...
                                                        <td>
                                                            <a href="{{url('super-admin/page-gallery/edit/'.$gallery->id.'/'.$page_id)}}" ><button type="button" class="btn btn-icon btn-rounded btn-outline-primary"><i class="fas fa-edit"></i></button></a>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            Are you sure you want to delete <b>{{$gallery->title}}</b>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <a href="{{route('page-gallery.destroy',$gallery->id)}}" class="btn btn-danger">Delete</a>
