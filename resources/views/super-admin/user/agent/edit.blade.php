                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:">Edit Agent</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form method="post" action="{{route('agent.update',$user->id)}}" enctype="multipart/form-data" autocomplete="off" data-parsley-validate>
                        {!! csrf_field() !!}
