        ...
        <div class="pcoded-wrapper">
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('reservation.index')}}">Booking</a></li>
                    ...
                    <form method="post" action="{{route('reservation.mail-send')}}" enctype="multipart/form-data" autocomplete="off" data-parsley-validate novalidate>
                        @csrf
                        <div class="main-body">
