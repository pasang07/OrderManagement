                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Edit Minimum Order Quantity</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route('superadmin.dashboard')}}">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{route('moq.index')}}">Minimum Order Quantity</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:">Edit MOQ</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form method="post" action="{{route('moq.update',$moq->id)}}" class="repeater" enctype="multipart/form-data" autocomplete="off" data-parsley-validate>
                        {!! csrf_field() !!}
                        @include('super-admin.product.moq.form')
                    </form>
                </div>
            </div>
        </div>
